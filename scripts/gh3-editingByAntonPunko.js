...
(function () {
	...
	Gh3.Users = Kind.extend({
		...
		search : function (keyword, pagesInfo, callback) {
			...
			Gh3.Helper.callHttpApi({
				service : "legacy/user/search/"+keyword + "?client_id=8e0949ccd9a302148c2f&client_secret=490ba27f02472d922802ae0b340e5a9c40a9fbd0",
				data : pagesInfo,
	...
	Gh3.User = Kind.extend({
		...
		fetch : function (callback) {
			...
			Gh3.Helper.callHttpApi({
				service : "users/"+that.login + "?client_id=8e0949ccd9a302148c2f&client_secret=490ba27f02472d922802ae0b340e5a9c40a9fbd0",
				success : function (res) {
	...
	Gh3.Commit = Kind.extend({
		...
		fetchComments : function (callback) {
			...
			Gh3.Helper.callHttpApi({
				service : "repos/"+that.user.login+"/"+that.repositoryName+"/commits/"+that.sha+"/comments" + "?client_id=8e0949ccd9a302148c2f&client_secret=490ba27f02472d922802ae0b340e5a9c40a9fbd0",
				success : function(res) {
					_.each(res.data, function (comment) {
	...
	Gh3.File = Gh3.ItemContent.extend({
		...
		fetchContent : function (callback) {
			...
			Gh3.Helper.callHttpApi({
				service : "repos/"+that.user.login+"/"+that.repositoryName+"/contents/"+that.path + "?client_id=8e0949ccd9a302148c2f&client_secret=490ba27f02472d922802ae0b340e5a9c40a9fbd0",
				success : function(res) {
		...
		fetchCommits : function (callback) {//http://developer.github.com/v3/repos/commits/
			...
			Gh3.Helper.callHttpApi({
				service : "repos/"+that.user.login+"/"+that.repositoryName+"/commits" + "?client_id=8e0949ccd9a302148c2f&client_secret=490ba27f02472d922802ae0b340e5a9c40a9fbd0",
	...
	Gh3.Repositories = Kind.extend({//http://developer.github.com/v3/repos/
		...
		search : function (keyword, pagesInfo, callback) {
			...
			Gh3.Helper.callHttpApi({
				service : "legacy/repos/search/"+keyword + "?client_id=8e0949ccd9a302148c2f&client_secret=490ba27f02472d922802ae0b340e5a9c40a9fbd0",
				data : pagesInfo,
				//beforeSend: function (xhr) { xhr.setRequestHeader ("rel", paginationInfo); },
				success : function(res) {
					//console.log("*** : ", res);
